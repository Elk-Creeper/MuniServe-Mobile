...
const Transaction = () => {
    ...
    useEffect(() => {
        ...
        const appointmentPage = firebase.firestore().collection("marriage_reg");
    ...
    const getStatusMessage = (item) => {
        ...
        switch (status) {
            ...
            case 'Rejected':
                return `Dear ${userName}, your request for Marriage Registration has been REJECTED.\n\nREMARKS: ${remarks}`;
            default:
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.regText}>Marriage Registration Transaction</Text>

...
const Transaction = () => {
    ...
    useEffect(() => {
        ...
        const appointmentPage = firebase.firestore().collection("deathCert");
    ...
    const getStatusMessage = (item) => {
        ...
        switch (status) {
            case 'Pending':
                return `Dear ${userName}, your request for Death Certificate is PENDING. REMARKS: ${remarks}`;
            case 'Approved':
                return `Dear ${userName}, your request for Death Certificate is already APPROVED and now ready to be processed. REMARKS: ${remarks}`;
            case 'On Process':
                return `Dear ${userName}, your request for Death Certificate is now ON PROCESS. Please wait for at least 10 days for it to be completed. REMARKS: ${remarks}`;
            case 'Completed':
                return `Dear ${userName}, your request for Death Certificate has been COMPLETED and ready to be claimed at the Office of Municipal Civil Registrar. Note that you can claim it during office hours and days. REMARKS: ${remarks}`;
            case 'Rejected':
                return `Dear ${userName}, your request for Death Certificate has been REJECTED. REMARKS: ${remarks}`;
            default:
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.regText}>Death Certificate Transaction</Text>
